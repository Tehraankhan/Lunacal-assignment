      ...
      >
        <div className="flex flex-row w-[90%] h-full  mx-auto">
          ...
          <div className=" w-full lg:w-1/2 h-full mx-auto  flex flex-col justify-evenly rounded-[10px]">
            ...
            <div class="w-[80%] mx-auto h-[5px] bg-gradient-to-b from-[rgba(40,40,40,0.1)] to-[rgba(248,248,248,0.1)] bg-[linear-gradient(0deg,rgba(255,255,255,0.05),rgba(255,255,255,0.05))]"></div>
